...
public class CalculatorController implements ActionListener {
	 ...
	 * @param view2 a View2 for what should be displayed in the GUI
	 */
	//added View2 object as parameter
	public CalculatorController(CalculatorModel model, CalculatorView view, View2 view2) {
		this.model = model;
		this.view = view;
		this.view2 = view2;
	}
	 ...
	 */
	//added View2 object & called methods to it
